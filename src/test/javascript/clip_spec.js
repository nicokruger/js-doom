describe("Basic polygon intersection", function() {
    it("should be able to detect whether two (convex) polygons intersect", function() {
        ...
        expect(renderlib.clip.poly_intersect_simple(poly1, poly2)).toBe(true);
    });
    it("should be able to detect whether two (convex) polygons DO NOT intersect", function() {
        ...
        expect(renderlib.clip.poly_intersect_simple(poly1, poly2)).toBe(false);
    });
    it("should be able to solve some more complex polygons intersection problems", function() {
        ...
        expect(renderlib.clip.poly_intersect_simple(octa, square)).toBe(true);
        expect(renderlib.clip.poly_intersect_simple(octa, square2)).toBe(true);
        expect(renderlib.clip.poly_intersect_simple(octa, square3)).toBe(false);
    });
