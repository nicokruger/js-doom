...
ViewportGL.prototype.draw = function (textures) {
    Timer.start("Sectordraw");

    //this.bitmapViewport.singleBitmap(textures, this.data);
    
    for (var i =0 ; i < 500 * 500 * 4; i++) {
    ...
    handleLoadedTexture(neheTexture, textures[0].imageData);
    Timer.subend();
