...
ViewportFullCanvas = function(sectors,viewport,x1,y1,x2,y2,ctx) {
...
ViewportFullCanvas.prototype.cartesian2screenx = function(x) {
    return x - this.x1;
}
ViewportFullCanvas.prototype.cartesian2screeny = function(y) {
    return this.y2 + (-1 * y);
}
...
ViewportFullCanvas.prototype.drawPoly = function(viewport, ctx, label, poly, colour, texture) {
